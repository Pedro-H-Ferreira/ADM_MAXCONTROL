...
const statusStyles: Record<string, string> = {
  ...
  ABERTO_NO_FLUIG: "border-emerald-500/25 bg-emerald-500/10 text-emerald-700 dark:text-emerald-300",
  ...
  VALIDADO: "border-amber-500/25 bg-amber-500/10 text-amber-700 dark:text-amber-300",
  NA_FILA: "border-amber-500/25 bg-amber-500/10 text-amber-700 dark:text-amber-300",
  ...
  EM_EXECUCAO: "border-sky-500/25 bg-sky-500/10 text-sky-700 dark:text-sky-300",
  ...
  ERRO: "border-red-500/25 bg-red-500/10 text-red-700 dark:text-red-300",
...
const urgentStatuses = new Set(["VENCIDO", "ATRASADA", "CRITICO", "DIVERGENTE", "FALHA", "ERRO"]);
